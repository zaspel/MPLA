...
//	mpla_dgemv_core = &mpla_dgemv_core_kernel_cublas;
	...
	// generate RHS
	mpla_set_gaussian_kernel_rhs(&b, &A, &instance);
	...
	mpla_generic_conjugate_gradient_with_checkpoint_restart(&b, &A, &x, 100000, tol, mpla_dgemv_core, iterations_until_checkpoint, restart, &instance);
